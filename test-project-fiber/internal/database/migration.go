...
import (
	...
	"github.com/test/test-project-fiber/internal/database"
	"github.com/test/test-project-fiber/internal/models"
	"gorm.io/gorm"
)
...
func seedData(db *gorm.DB) error {
	...
	defaultSettings := []models.Setting{
		{Key: "site_name", Value: "TEST-PROJECT-FIBER", Type: "string"},
	...
	adminEmail := "admin@test-project-fiber.com"
