...
<div align="center">
    ...
    <a href="https://goreportcard.com/report/github.com/NarmadaWeb/goback">
        <img src="https://img.shields.io/goreportcard/github/NarmadaWeb/goback?style=for-the-badge&color=brightgreen" alt="Go Report Card">
    </a>
    <a href="#">
        <img src="https://img.shields.io/github/actions/workflow/status/NarmadaWeb/goback/go.yml?style=for-the-badge&logo=github" alt="Build Status">
    </a>
...
<p align="center">
  <img src="link/to/your/demo.gif" alt="GoBack TUI Demo" width="80%">
</p>
...
```bash
go install [github.com/NarmadaWeb/goback/cmd/goback@latest](https://github.com/NarmadaWeb/goback/cmd/goback@latest)
````

### From Source

```bash
git clone [https://github.com/NarmadaWeb/goback.git](https://github.com/NarmadaWeb/goback.git)
cd goback
go build .
...
goback new user-service \
  ...
  --orm gorm \
  --architecture clean \
  --module [github.com/my-org/user-service](https://github.com/my-org/user-service)
