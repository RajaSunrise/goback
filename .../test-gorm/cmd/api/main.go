...
import (
	...
	"github.com/user/test-gorm/internal/config"
	"github.com/user/test-gorm/internal/database"
	"github.com/user/test-gorm/internal/middleware"
	"github.com/user/test-gorm/internal/routes"
